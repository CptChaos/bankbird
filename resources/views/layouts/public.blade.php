...
<nav class="bb-nav">
    <div class="bb-nav-inner">
        ...
        <div class="bb-nav-links">
            ...
            <a href="https://github.com" target="_blank" class="bb-nav-link github">
    ...
    <div class="bb-wrap">
        <div style="display:flex; flex-wrap:wrap; align-items:center; justify-content:space-between; gap:2rem; margin-bottom:2rem;">
            ...
            <nav style="display:flex; flex-wrap:wrap; gap:0.25rem;">
                @foreach([['/', 'Home'], ['/demo', 'Demo'], ['/install', 'Installatie'], ['/kennisbank', 'Kennisbank'], ['/docs', 'Documentatie'], ['/vibe-dev', 'Vibe Dev'], ['/over', 'Over'], ['/updates', 'Updates'], ['https://github.com', 'GitHub ↗']] as [$href, $label])
