...
return [
    ...
    */
    ...
    /*
    | Lokale gecombineerde host: één Herd-/Valet-domein dat demo en admin
    | via path-prefixes serveert (`/demo`, `/dev`). Productie blijft
    | onveranderd op aparte hosts. Leeg laten in productie.
    */
